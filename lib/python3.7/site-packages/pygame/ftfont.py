...
from pygame import init, Font as _Font, get_default_resolution
from pygame import quit, get_default_font, get_init as _get_init
from pygame import __PYGAMEinit__
from pygame import match_font, get_fonts, SysFont as _SysFont
